...
<main class="main">
  <section class="search">
    <div class="container search__container" tabindex="0">
      <h1 class="title search__title centered">Результаты поиска</h1>
      <div class="blog-wrapper">
        ...
        ?>
          <ul class="list-reset blog-wrapper__list" data-page="<?= $page; ?>" data-max="<?= $wp_query->max_num_pages; ?>" data-value="<?= $_GET['s']; ?>">
            <?php
            while (have_posts()) {
              the_post();
          ...
          <?php
            ...
            echo '<span class="search__desc">Ничего не найдено</span>';
          }
          ?>
          </ul>
